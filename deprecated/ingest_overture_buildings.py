...
def load_overture_buildings(bounds_in_path: str, cities_data_out_dir: str) -> None:
    """ """
...
if __name__ == "__main__":
    """
    python -m src.data.ingest_overture_buildings temp/datasets/boundaries.gpkg temp/cities_data
    """
    if True:
